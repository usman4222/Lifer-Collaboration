...
const Help = ({ toggleRepresentator }) => {
    ...
    const answer = [
        {
            id: 1,
            answer: 'Grilled Chicken Caesar Salad: Fresh twist with grilled chicken, crunchy croutons, and Parmesan on crisp romaine, drizzled with our signature Caesar dressing.',
        },
        {
            id: 2,
            answer: 'Grilled Chicken Caesar Salad: Fresh twist with grilled chicken, crunchy croutons, and Parmesan on crisp romaine, drizzled with our signature Caesar dressing.',
